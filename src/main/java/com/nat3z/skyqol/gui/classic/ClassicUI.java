package com.nat3z.skyqol.gui.classic;
...
public class ClassicUI extends GuiScreen {
    ...
    public void initGui() {
		...
		buttonList.add(new GuiButton(789, width - 200, 0, "Edit Gui Locations"));
    ...
    protected void actionPerformed(final GuiButton guiButton) {
        if (guiButton.enabled) {
        	...
        	switch (buttonwithout) {
    			...
    			case "Click Anywhere to Open Maddox: Enabled":
    				Main.config.setMaddoxautophone(false);
    				break;
            	
    			case "Click Anywhere to Open Maddox: Disabled":
    				Main.config.setMaddoxautophone(true);
            		break;
            		
    			case "Secrets Hud: Enabled":
    				Main.config.setSecrethud(false);
    				break;
            	
    			case "Secrets Hud: Disabled":
    				Main.config.setSecrethud(true);
            		break;
            		
    			case "Edit Gui Locations":
		...
		switch (page) {
			...
			case 2:
				...
				if (Main.config.isMaddoxautophone())
					button3.displayString = "Click Anywhere to Open Maddox: " + EnumChatFormatting.GREEN + "Enabled";
				else
					button3.displayString = "Click Anywhere to Open Maddox: " + EnumChatFormatting.RED + "Disabled";
				
				if (!Main.config.modules.get("maddoxautophone").booleanValue())
					button3.displayString = "Click Anywhere to Open Maddox: " + EnumChatFormatting.DARK_GRAY + "Force Disabled";


				
				
				if (Main.config.isSecrethud())
					button4.displayString = "Secrets Hud: " + EnumChatFormatting.GREEN + "Enabled";
				else
					button4.displayString = "Secrets Hud: " + EnumChatFormatting.RED + "Disabled";
				
				if (!Main.config.modules.get("secrethud").booleanValue())
					button4.displayString = "Secrets Hud: " + EnumChatFormatting.DARK_GRAY + "Force Disabled";
