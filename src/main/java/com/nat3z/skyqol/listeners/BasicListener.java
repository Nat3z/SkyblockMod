...
public class BasicListener {
    ...
    public void onTick(ItemTooltipEvent event) {
    	...
    	if(event.itemStack.getDisplayName().toLowerCase().contains("open reward chest")) {
    		
    		double money = 0;
    		String slotinv11 = p.openContainer.getSlot(11).getStack().getDisplayName().toString().toLowerCase();
    		slotinv11 = StringUtils.stripControlCodes(slotinv11);
    		String slotinv12 = p.openContainer.getSlot(12).getStack().getDisplayName().toString().toLowerCase();
    		slotinv12 = StringUtils.stripControlCodes(slotinv12);
    		String slotinv13 = p.openContainer.getSlot(13).getStack().getDisplayName().toString().toLowerCase();
    		slotinv13 = StringUtils.stripControlCodes(slotinv13);
    		
    		String book11 = ItemUtils.getItemLore(p.openContainer.getSlot(11).getStack()).toString().toLowerCase();
    		book11 = StringUtils.stripControlCodes(book11);
    		String book12 = ItemUtils.getItemLore(p.openContainer.getSlot(12).getStack()).toString().toLowerCase();
    		book12 = StringUtils.stripControlCodes(book12);
    		String book13 = ItemUtils.getItemLore(p.openContainer.getSlot(13).getStack()).toString().toLowerCase();
    		book13 = StringUtils.stripControlCodes(book13);
    		...
    		if(slotinv11.contains("✪✪✪✪✪"))
    			...
    			money = money + 54000.0;
    		*/
    		String toolTip = event.itemStack.getTagCompound().getCompoundTag("display").getTagList("Lore", 8).getStringTagAt(6).replaceAll(",", "").replace("Coins", "").replaceAll(" ", "").toString();
