...
public class RenderUtil {
    ...
    public static void drawOutlineBoundingBox(AxisAlignedBB p_181561_0_, float alpha, Color color) {
    	/* HOW TO MAKE OUTLINE
    	 *
        ...
        GlStateManager.depthMask(false);
 	    ...
 	    RenderUtil.drawOutlineBoundingBox(Blocks.stone.getSelectedBoundingBox(Minecraft.getMinecraft().theWorld, new BlockPos(-10, 109, 6)).offset(-d0, -d1, -d2), 1f, Color.green);
